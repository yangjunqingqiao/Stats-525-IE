...
#Questions
###These are the questions posed by the site in which we found the data. 
...
ols1 <- lm(Total.density ~ Profile.Area + Half.height)
summary(ols1)
```
